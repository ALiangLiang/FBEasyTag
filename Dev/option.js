...
function() {
	...
	document.onkeydown = function(e) {
		if (e.ctrlKey) {
			if (e.keyCode == 65) {
				if (db) for (var i in document.querySelectorAll(".AT-name")) 
					document.querySelectorAll(".AT-name")[i].className = "AT-name btn btn-default";
				else for (var i in document.querySelectorAll(".AT-name")) 
					document.querySelectorAll(".AT-name")[i].className = "AT-name btn btn-default active";
				db = !db;
			}
		}
	}
	var s = document.querySelectorAll(".AT-name");
	for (var i in s) 
